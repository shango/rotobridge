...
(function () {
    ...
    alert("RotoBridge test scene built on layer 'RotoBridge test'.\n"
          ...
          + "               and the reimport must come back still open. Do\n"
          + "               NOT expect a matte: After Effects produces no\n"
          + "               alpha from an open mask path at all. This is a\n"
          + "               data round trip, not a rendered one.\n"
